...
namespace ShareX.UploadersLib.FileUploaders
{
    public class YouTubeFileUploaderService : FileUploaderService
    {
        ...
        public override Image ServiceImage => null;
    ...
    public sealed class YouTube : FileUploader, IOAuth2
    {
        ...
        public override UploadResult Upload(Stream stream, string fileName)
        {
            ...
            // YouTubeVideoOptionsForm (WinForms dialog) not available on macOS.
            // Title, description, and visibility use configured defaults.
